...
import { getCurrentUserProfile } from "@database/services/superapp"
import { getColleges } from "@database/services/api"
...
export default function CollegeDirectory() {
  ...
  return (
    <div>
      {/* ── SEO Meta ── */}
      <Helmet>
        <title>College Directory 2024 | Find Top NITs, IITs & Universities | TAKक्षक</title>
        <meta name="description" content="Explore India's premier educational institutions. Filter by state, stream, and admission mode to find your perfect college with TAKक्षक." />
      </Helmet>
